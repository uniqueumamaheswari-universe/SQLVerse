...
```mermaid
flowchart LR
    A["🎉 CELEBRATE<br/>Your progress"] --> B["🧱 BUILD<br/>Schema & data"]
    B --> C["📥 COLLECT GEMS<br/>CSV import"]
    C --> D["🧠 QUERY & DISPLAY<br/>Showcase insights"]
    D --> E["🧨 INTERVIEW WEAPON<br/>MATRIX RELOADED"]
    E --> F["🏆 PORTFOLIO SHINES<br/>ACQUIRE complete"]
...
flowchart LR
    ...
    B --> C["📍 ACQUIRE COMPLETION<br/>YOU ARE HERE"]
