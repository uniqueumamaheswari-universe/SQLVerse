...
```mermaid
flowchart LR
    A["Tab 1: READ Socratic Mirror<br/>(Receptive Mode)"] --> 
    B["Tab 3: PROMPT the AI<br/>(Strategic Mode)"] --> 
    C["Tab 2: WRITE SQL manually<br/>(Productive Mode)"] --> 
    D["Tab 4: LOG the dialogue<br/>(Integrative Mode)"]
    
    style A fill:#fff8e1,stroke:#ff9800,stroke-width:3px
    style B fill:#f3e5f5,stroke:#9c27b0,stroke-width:3px
    style C fill:#e1f5fe,stroke:#2196f3,stroke-width:3px
