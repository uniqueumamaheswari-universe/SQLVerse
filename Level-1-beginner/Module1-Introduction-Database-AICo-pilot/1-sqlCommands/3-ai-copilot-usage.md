...
flowchart LR
    ...
    B["✅ COMPLETED<br/>📘 File 2<br/>Database Components"] --> C
    C["📍 YOU ARE HERE<br/>📘 File 3<br/>AI Co-pilot Usage"] --> D
...
flowchart LR
    subgraph SQLVERSE["🌌 THE SQLVERSE"]
        direction LR
        Start["File 1<br/>What is a Database?"] --> File2["File 2<br/>Database Components"]
        File2 --> Current["📍 File 3<br/>AI Co-pilot Usage<br/>YOU ARE HERE"]
        Current --> Complete["✅ PREPARE<br/>COMPLETE"]
        Complete --> Practice["🔄 PRACTICE STAGE<br/>🛒 E-Commerce Planet"]
        Practice --> Evaluate["📝 EVALUATE STAGE"]
        Evaluate --> Guide["📖 Module 1 Guide<br/>for Reflection"]
    end
    
    style Start fill:#e1f5fe,stroke:#4caf50,stroke-width:4px
    style File2 fill:#e1f5fe,stroke:#4caf50,stroke-width:4px
